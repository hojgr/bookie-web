...
trait AuthenticatesAndRegistersUsers
{
    ...
    public function postLogin(Request $request)
    {
        ...
        return redirect($this->loginPath())->withInput($request->only('email', 'remember'))->withErrors(array('email' => $this->getFailedLoginMesssage()));
    }
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        $binds = array('BookieGG\\Contracts\\Repositories\\UserRepositoryInterface' => UserRepository::class, 'BookieGG\\Contracts\\Repositories\\BetaSubscriptionRepositoryInterface' => BetaSubscriptionRepository::class, 'BookieGG\\Contracts\\SteamUtilityInterface' => SteamUtility::class, 'BookieGG\\Contracts\\LogoUtilityInterface' => LogoUtility::class, 'BookieGG\\Contracts\\Repositories\\OrganizationRepositoryInterface' => OrganizationRepository::class, 'BookieGG\\Contracts\\Repositories\\TeamRepositoryInterface' => TeamRepository::class, 'BookieGG\\Contracts\\Repositories\\MatchRepositoryInterface' => MatchRepository::class, 'BookieGG\\Contracts\\Repositories\\ArticleRepositoryInterface' => ArticleRepository::class, 'BookieGG\\Contracts\\Repositories\\SubpageRepositoryInterface' => SubpageRepository::class, 'BookieGG\\Contracts\\ImageManagerInterface' => ImageManager::class, 'BookieGG\\Contracts\\TimeUtilityInterface' => TimeUtility::class, 'BookieGG\\Contracts\\SubpageServiceInterface' => SubpageService::class, 'BookieGG\\Contracts\\NoteHelperInterface' => NoteHelper::class);
...
class BusServiceProvider extends ServiceProvider
{
    public function boot(Dispatcher $dispatcher)
    {
        $dispatcher->mapUsing(function ($command) {
            return Dispatcher::simpleMapping($command, 'BookieGG\\Commands', 'BookieGG\\Handlers\\Commands');
        });
    }
    public function register()
    {
...
class EventServiceProvider extends ServiceProvider
{
    protected $listen = array('router.matched' => array('BookieGG\\Handlers\\Events\\NewRelicRouterMatched'));
    public function boot(DispatcherContract $events)
    {
        parent::boot($events);
    }
