...
Route::group(['middleware' => 'beta.not_active_only'], function() {
	Route::get('/beta', ['as' => 'beta_home', 'uses' => 'BetaController@index']);
	Route::post('/beta', ['as' => 'beta.activate', 'uses' => 'BetaController@activate']);
	Route::post('/beta/subscribe', ['as' => 'beta.subscribe', 'uses' => 'BetaSubscribeController@index']);
});
